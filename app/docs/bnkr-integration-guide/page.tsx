      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="card mb-6">
          ...
          <ul className="list-disc pl-6 text-sm text-text-dim space-y-1">
            ...
            <li>Use MPP for session-based or one-time payments (supports Tempo, Stripe, Solana, Lightning, and more), or x402 for HTTP 402 per-request payments on any supported chain.</li>
