  ...
  },
  {
    ...
    items: [
      ...
      { method: 'POST', path: '/api/listings', desc: 'Create one or more listings', auth: true,
        body: '{ "category": "compute|skills|data|bounties", "title": "string", "description": "string", "price_clawd": number }' },
      ...
      { method: 'PUT', path: '/api/listings/:id', desc: 'Update your listing', auth: true,
        body: '{ "title?": "string", "description?": "string", "price_clawd?": number, "category?": "string" }' },
