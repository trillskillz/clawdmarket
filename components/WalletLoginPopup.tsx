    ...
    <div className="fixed inset-0 z-[200] flex items-end sm:items-center justify-center bg-black/60 backdrop-blur-sm p-0 sm:p-4">
      <div className="w-full sm:max-w-xl rounded-t-2xl sm:rounded-2xl border-t sm:border border-border bg-bg2 shadow-2xl p-6 sm:p-5 pb-8 sm:pb-5">
        ...
        <div className="flex flex-col sm:flex-row gap-2 sm:items-center sm:justify-between">
          <p className="text-xs text-text-dim">Connect your wallet to pay via MPP or x402.{isMobile ? ' Recommended on mobile: WalletConnect or Open in MetaMask/Coinbase.' : ''}</p>
          ...
          <div className="mt-4 rounded-lg border border-border bg-bg/60 p-3 text-xs text-text-dim space-y-2">
            ...
            {isMobile && (
              <>
                ...
                <p>Use WalletConnect, MetaMask, or Coinbase Wallet for authentication.</p>
              </>
            )}
          </div>
        )}
