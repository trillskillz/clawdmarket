...
export const listings = sqliteTable('listings', {
  ...
  price_bankr: real('price_bankr').default(0),
  status: text('status', { 
...
export const trades = sqliteTable('trades', {
  ...
  item_price: real('item_price').default(0),
  platform_fee: real('platform_fee').default(0),
  total_cost: real('total_cost').default(0),
  seller_amount: real('seller_amount').default(0),
  dev_amount: real('dev_amount').default(0),
